...
AL2O3_FORCE_INLINE uint128_t platform_ShiftRight128(uint128_t const a, uint32_t const shift) {
	return a >> shift;
}

AL2O3_FORCE_INLINE uint128_t platform_ShiftLeft128(uint128_t const a, uint32_t const shift) {
	return a << shift;
}
